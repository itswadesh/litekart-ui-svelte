...
<div class="flex justify-center p-5">
  <div class=" flex justify-around flex-wrap">
    <div
      class="flex flex-col justify-center text-center items-center p-8 w-full
      lg:w-1/3">
      <img use:lazyload  src="img/fastestexperience.svg" alt="" class="h-24 m-8" />
      <div class="m-4">
    ...
    <div
      class=" flex flex-col justify-center text-center items-center p-8 w-full
      lg:w-1/3">
      <img use:lazyload  src="img/flexiblescope.svg" alt="" class="h-24 m-8" />
      <div class="m-4 ">
    ...
    <div
      class=" flex flex-col justify-center text-center items-center p-8 w-full
      lg:w-1/3">
      <img use:lazyload  src="img/building.svg" alt="" class="h-24 m-8" />
      <div class="m-4">
